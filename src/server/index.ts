...
import { makeTestDigestHandler, makeTestRuntimeEventsHandler, makeTestDailyAceHandler } from './bot/test-commands.ts';
...
if (botToken) {
  ...
  bot.command('test_daily_ace', makeTestDailyAceHandler({ db, bot }));
