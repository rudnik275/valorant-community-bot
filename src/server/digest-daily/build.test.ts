...
describe('buildDailyAceDigest', () => {
  ...
  describe('header and legend', () => {
    it('renders plain header and blockquote legend with 6 lines (no italic)', async () => {
      ...
      // Legend is one blockquote with 6 plain lines (no <i>, no <b>).
      // 4th line (🎯🦢) tags an ace where ALL victims were AFK ("стадо гусей").
      // 6th line (🔪🦢) tags a knife kill of an AFK victim ("гусь").
