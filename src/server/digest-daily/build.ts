 ...
 *
 * The «распотрошил гуся» (AFK victim) split is retired (owner, 2026-08-04) —
 * a knife kill is a knife kill. `payload.victims_afk` exists only on
 ...
 * 🎯 Эйсы / 🔪 Ножи sections of flat `ник · раунды · матч` lines, grouped by
 * player; the striped tables are gone since 2026-08-24) via `./rich-render.ts`.
