...
**Daily digest** — пост «🍿 Daily Ace/Knife» в 23:00 Киева (`digest-daily/`): два булет-списка счётчиков за сутки — «🎯 Aces» и «🔪 Knives», строка = `Ник#Тег ×N` (без иконки ранга, агента, карты, ссылок и номеров раундов; `×1` не печатается), сортировка по счёту, при равенстве — кто раньше. Считает по тем же правилам, что Ace/knife leaderboard. Формат с 2026-09-07 (ADR 0003, секция 2026-09-07); до этого — хронологический построчный список моментов (2026-08-18…2026-09-06). Удалён 2026-08-04 в пользу недельных счётчиков, возвращён 2026-08-18 — живут оба. Дедуп по киевской дате в `daily_digest_runs`; день без событий — без поста. Owner-превью — `/test_daily_digest [N]`.
