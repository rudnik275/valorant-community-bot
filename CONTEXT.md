...
**Доска недели (leaderboard)** — единая форма для всех ранжированных списков дайджеста: строка-заголовок, дальше `<🥇🥈🥉|•> подпись — N`, отсортировано по убыванию. В этой форме идут эйсы, ножи, карты и агенты. Карты и агенты показываются ПОЛНОСТЬЮ, без отсечки топ-3 (владелец, 2026-08-04) — за реальную неделю это ~7 карт и ~28 агентов.
